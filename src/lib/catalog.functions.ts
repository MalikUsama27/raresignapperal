...
export const listProducts = createServerFn({ method: "GET" })
  ...
  .handler(async ({ data }) => {
    ...
    let query = supabase
      .from("products")
      .select("id, slug, name, sku, short_description, image_url, gallery, is_featured, category_id, subcategory_id, categories(name, slug), subcategories(name, slug)", { count: "exact" });
...
export const getProduct = createServerFn({ method: "GET" })
  ...
  .handler(async ({ data }) => {
    ...
    const { data: related } = await supabase
      .from("products")
      .select("id, slug, name, sku, short_description, image_url, gallery, is_featured, category_id, subcategory_id, categories(name, slug), subcategories(name, slug)")
